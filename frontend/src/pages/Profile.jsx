  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      const initialData = {
        ...
        email: parsedUser.email || "alex.johnson@example.com",
        username: parsedUser.username || "@alexdraws",
        bio: "Creative thinker | Digital artist | Coffee enthusiast ☕",
      };
  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-2xl mx-auto p-4">
        {/* Profile Card */}
        <div className="bg-white border-[3px] border-black rounded-2xl p-8 shadow-[8px_8px_0_#000] relative">
